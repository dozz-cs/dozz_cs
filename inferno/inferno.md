...
1. **BANANA** [(Top)](#s-top)
   ...
   - Mira: Alinhe a mira com a quina do telhado da torre da igreja. Levante a mira na altura do arco.
   - Execução: Arremesso longo;
   - Ref. 121.8874: [YouTube](https://youtu.be/fxNPvsMPIrA)
...
1. **BANANA** [(Top)](#s-top)
   - Alvo: BOMB B;
   - Posição: Encoste no canto do muro com o barril, próximo ao carrinho de carga vermelho;
...
1. **BANANA** [(Top)](#s-top)
   ...
   - Mira: Mire em uma mancha escura à esquerda da ponta da flecha pintada na mureta;
   - Execução: Jumpthrow longo;
...
1. **BASE CT** [(Top)](#s-top)
   - Alvo: CARRO;
   - Posição: Posicione-se em cima da calçada elevada no canto da parede com o guarda-sol verde próximo a entrada para a biblioteca/adega;
   - Mira: Alinhe a mira com a esquerda da soleira da janela com a pequena sacada. Mire na altura da linha horizontal branca;
   - Execução: Jumpthrow longo;
   - Ref. 121.0473: [YouTube](https://youtu.be/d27W6Cg7Ax8)
...
1. **BASE CT** [(Top)](#s-top)
   - Alvo: MEIO BAIXO;
   - Posição: Posicione-se em frente a lança tripla esquerda sobre o muro baixo;
   - Mira: Mire em uma pequena saliência à esquerda da viga de madeira no beiral próximo ao canto esquerdo da sacada com os barris;
   - Execução: W + Jumpthrow longo;
   - Ref. 121.6534: [YouTube](https://youtu.be/WX2EI8hSpGA)

1. **BASE CT** [(Top)](#s-top)
   - Alvo: MEIO BAIXO;
   - Posição: Posicione-se no canto da floreira do chão com a quina da parede da construção da capela;
   - Mira: Mire em uma pequena saliência da mão-francesa no beiral da construção localizado acima da entrada para o arco;
   - Execução: Jumpthrow longo;
   - Ref. 121.1837: [YouTube](https://youtu.be/qdj7hU02ZX4)
...
1. **BOMB B** [(Top)](#s-top)
   - Alvo: CARRO;
   - Posição: Encoste no canto da fonte na região frontal do chafariz;
...
1. **CORREDOR CT** [(Top)](#s-top)
   - Alvo: CT;
   - Posição: Pare na região da escada próximo a coluna à esquerda;
...
1. **CAIXÃO** [(Top)](#s-top)
   ...
   - Mira: Localize uma pedra saliente na região do sanduíche. Mire na parte inferior esquerda dessa pedra;
   - Execução: Jumpthrow longo;
...
1. **CAVERNA** [(Top)](#s-top)
   ...
   - Mira: Alinhe a mira com o lado esquerdo da janela. Mire na no topo do arco da saída da caverna;
   - Execução: Jumpthrow longo;
...
1. **MEIO** [(Top)](#s-top)
   ...
   - Mira: Localize o nicho em forma de arco com o desenho na parede. Mire na junção entre a primeira e a segunda pedra, de baixo para cima, no canto esquerdo do arco;
   - Execução: Jumpthrow longo;
...
1. **MEIO (1/2)** [(Top)](#s-top)
   ...
   - Mira: Localize a calha cinza no telhado da construção. Mire na extremidade da calha, alinhado com a ripa de madeira do beiral.
   - Execução: Jumpthrow longo;
   - Ref. 121.7633: [YouTube](https://youtu.be/teIC-oMociI)
...
1. **MEIO (2/2)** [(Top)](#s-top)
   ...
   - Execução: Jumpthrow longo;
   - Ref. 121.7634: [YouTube](https://youtu.be/9OyRbHrmokA)
...
1. **MEIO** [(Top)](#s-top)
   ...
   - Mira: Mire no meio da parede abaixo da janela;
   - Execução: Arremesso longo;
...
1. **MEIO FALSO** [(Top)](#s-top)
   ...
   - Mira: Mire na região central inferior da janela veneziana na construção vermelha;
   - Execução: Jumpthrow longo;
...
1. **NIP** [(Top)](#s-top)
   - Alvo: FALLEN;
   - Posição: Encoste no canto de um pequeno nicho próximo a quina da parede;
...
1. **PISCINA** [(Top)](#s-top)
   - Alvo: CAVERNA;
   - Posição: Encoste no canto da mureta com a parede da igreja;
...
1. **ARCO** [(Top)](#m-top)
   ...
   - Mira: Mire no topo do telhado, próximo a quina da parede e alinhado com uma mancha escura;
   - Execução: Jumpthrow longo;
...
1. **BANANA (MADEIRA)** [(Top)](#m-top)
   - Alvo: CIMENTO;
   - Posição: Encoste na parede do fundo, atrás dos barris;
...
1. **BOMB B** [(Top)](#m-top)
   - Alvo: CARRO;
   - Posição: Encoste em um canto do chafariz, na parte frontal do bomb;
...
1. **CT** [(Top)](#m-top)
   - Alvo: MURETA DA PISCINA;
   - Posição: Pare próximo ao canto da parede da igreja ao lado do vaso de planta. Para facilitar a execução não encoste no canto;
   - Mira: Localize a decoração horizontal abaixo da janela. Mire próximo a quina da construção;
   - Execução: Ande para frente + Arremesso longo;
   - Ref. 122.1862: [YouTube](https://youtu.be/FrxZthl7o5w)
...
1. **CT** [(Top)](#m-top)
   ...
   - Mira: Mire na chaminé ao fundo e no alto da construção;
   - Execução: Ande para a frente + Arremesso longo;
...
1. **CT** [(Top)](#m-top)
   ...
   - Mira: Mire um pouco acima do rodapé, no final de uma mancha branca na parede vermelha;
   - Execução: Ande para a frente + Jumpthrow longo;
...
1. **CAIXÃO** [(Top)](#m-top)
   ...
   - Posição: Posicione-se em cima dos sacos de cimento na região do caixão;
   - Mira: Localize uma pedra saliente na região do BTT. Mire na região inferior dessa pedra, na fileira de pedras próxima ao chão;
   - Execução: Jumpthrow longo;
...
1. **CARRO** [(Top)](#m-top)
   - Alvo: ESCURO;
   - Posição: Suba na mureta e pare atrás do telhado;
...
1. **FALLEN** [(Top)](#h-top)
   - Alvo: TRIPLA;
   - Posição: Posicione-se próximo a marcação reta no chão. Encoste na parede direita, ficando de frente para as caixas do Sanduiche;
   - Mira: Mire na ponta de uma árvore baixa, acima do telhado na região da tripla;
   - Execução: Arremesso longo;
   - Ref. 122.9456: [YouTube](https://youtu.be/cmfvzwfg4y4)
...
1. **IGREJA**
   ...
   - Mira: Mire na região superior da janela em forma de arco, próximo ao céu azul;
   - Execução: Arremesso longo;
...
1. **SANDUÍCHE** [(Top)](#m-top)
   - Alvo: CARRO;
   - Posição: Suba na caixa do sanduíche sem a lona azul. Posicione a mira sobre o buraco no lado direito e no centro da caixa;
   - Mira: À direita, mire na junção dos ferros do andaime com a calha;
...
1. **TAPETE** [(Top)](#m-top)
   ...
   - Mira: Mire em uma tênue mancha escura no batente da porta, abaixo da linha da pintura amarela;
   - Execução: Arremesso longo;
   - Ref. 122.6399: [YouTube](https://youtu.be/V7EwglR9ZSg)
...
1. **AREIA 2** [(Top)](#f-top)
   - Alvo: TAPETE;
   - Posição: Pare na região da canaleta no chão da areia 2. Alinhe o canto superior esquerdo da porta do tapete com a quina da caixa;
   - Mira: Mire na peça no alto da antena do tipo espinha de peixe;
   - Execução: Arremesso longo;
...
1. **BANANA** [(Top)](#f-top)
   ...
   - Posição: Encoste na pequena parede atrás do muro do carro;
   - Mira: Alinhe a mira com a altura do telhado e com o ferro do andaime na região do bomb;
   - Execução: Arremesso longo;
   - Ref. 123.9723: [YouTube](https://youtu.be/nRrm7D6nKWM)

1. **BANANA** [(Top)](#f-top)
   - Alvo: FALLEN; CIMENTO; CAIXÃO; CT;
   - Posição: Posicione-se no meio da calçada, alinhado com os barris de madeira;
   - Mira: Mire na ponta do caibro logo abaixo do telhado acima da mureta da banana;
   - Execução: Arremesso longo;
   - Ref. 123.2833: [YouTube](https://youtu.be/_tK4B7jAlsM)

1. **BANANA** [(Top)](#f-top)
   - Alvo: FALLEN; CIMENTO;
   - Posição: Posicione-se em frente a uma emenda no lado esquerdo do muro próximo da saída da caverna;
   - Mira: Mire na ponta da decoração logo acima da janela próxima a mureta;
   - Execução: Arremesso longo;
...
1. **BANANA** [(Top)](#f-top)
   ...
   - Mira: Localize a ponta do telhado na torre da igreja. Mire ligeiramente abaixo do telhado.
   - Execução: Ande ligeiramente para a frente + Arremesso longo;
   - Ref. 123.2649: [YouTube](https://youtu.be/Wqpe8VGFoGs)

1. **BANANA** [(Top)](#f-top)
   - Alvo: CAIXÃO; TRIPLA; CT;
   - Posição: Encoste as costas no barril de madeira;
   - Mira: Mire na junção dos barris localizados à esquerda do carro, na altura da cinta metálica mais alta.
   - Execução: Jumpthrow longo;
...
1. **BASE TR, SAÍDA** [(Top)](#f-top)
   - Alvo: BANANA; CARRO;
   - Posição: Encoste na quina da parede direita da escada de acesso a cozinha;
...
1. **BASE TR, SAÍDA** [(Top)](#f-top)
   - Alvo: BANANA; CARRO;
   - Posição: Encoste na frente do corrimão de acesso ao apartamento;
   - Mira: Alinhe a mira verticalmente com a placa vermelha. Mire entre os beirais dos telhados, na parede vermelha;
   - Execução: Arremesso longo;
...
1. **BOMB B** [(Top)](#f-top)
   - Alvo: BANANA;
   - Posição: Encoste na lateral da coluna cilíndrica ao lado da tripla;
   - Mira: Mire no canto superior esquerdo da janela verde;
   - Execução: Arremesso longo;
...
1. **CAIXÃO** [(Top)](#f-top)
   - Alvo: CARRO; BANANA;
   - Posição: Posicione-se em cima do cimento na região do caixão;
...
1. **CAIXÃO** [(Top)](#f-top)
   - Alvo: BANANA;
   - Posição: Posicione-se em cima do cimento na região do caixão;
   - Mira: Mire na peça de metal do meio na quina da caixa direita do sanduíche;
   - Execução: Jumpthrow longo;
...
1. **CARRO** [(Top)](#f-top)
   - Alvo: BOMB B; TRIPLA; CAIXÃO; ESCURO; CT;
   - Posição: Encoste no canto da parede com a mureta;
   - Mira: Mire na ponta inferior da letra C da direita;
   - Execução: Jumpthrow médio;
...
1. **CIMENTO** [(Top)](#f-top)
   - Alvo: BANANA;
   - Posição: Encoste no canto da parede com o cimento;
   - Mira: Mire na quina mais afastada da floreira no alto da construção;
...
1. **CT** [(Top)](#f-top)
   - Alvo: BANANA;
   - Posição: Encoste na coluna da parede da igreja em frente ao pezinho;
...
1. **TAPETE** [(Top)](#f-top)
   ...
   - Mira: Agache, mire no topo das janelas à esquerda na torre que aparece ao lado da placa verde;
...
1. **BTT** [(Top)](#h-top)
   - Alvo: MURETA DA BANANA;
   - Posição: Posicione-se em cima da caixa do BTT com a lona azul. Alinhe a mira com o centro de uma pedra na frente da caixa;
   - Mira: Mire em uma tênue mancha na parede. A mancha está alinhada verticalmente com a fresta no piso da caixa;
   - Execução: Jumpthrow longo;
...
1. **CT** [(Top)](#h-top)
   - Alvo: TRIPLA;
   - Posição: Encoste na coluna da grade próxima a pequena escada para o corredor CT;
   - Mira: Mire na altura do rodapé, próximo a mancha branca na parede vermelha;
   - Execução: Ande para a frente + Jumpthrow longo;
   - Ref. 124.1955: [YouTube](https://youtu.be/xSs0JruXy1U)
...
1. **FALLEN** [(Top)](#h-top)
   ...
   - Execução: Arremesso longo;
   - Ref. 124.2749: [YouTube](https://youtu.be/N80VTUng018)

1. **FALLEN** [(Top)](#h-top)
   - Alvo: MURETA DA BANANA;
   - Posição: Posicione-se próximo ao batente direito da porta;
   - Mira: Mire na região de sombra, próximo a quina da construção;
...
1. **FALLEN** [(Top)](#h-top)
   ...
   - Mira: Mire na ponta de uma árvore baixa, acima do telhado na região da tripla;
   - Execução: Arremesso longo;
   - Ref. 124.9456: [YouTube](https://youtu.be/atgJzXghEN4)
...
1. **TAPETE** [(Top)](#h-top)
   ...
   - Mira: Mire em uma tênue mancha escura no batente da porta, abaixo da linha da pintura amarela;
   - Execução: Arremesso longo;
   - Ref. 124.6399: [YouTube](https://youtu.be/0Jqf_-BL_IQ)
